package com.yhfund.net.defconfig;


import android.content.Context;

import com.yhfund.net.RetrofitManager;
import com.yhfund.net.utils.NetWorkUtils;
...
public class DefInterceptorCommon implements Interceptor {
    ...
    public DefInterceptorCommon (Context context) {
        ...
        mCacheFile = new File( context.getExternalCacheDir(), "YHFundEE_Cache");
